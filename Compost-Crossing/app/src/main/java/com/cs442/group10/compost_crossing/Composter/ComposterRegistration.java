...
public class ComposterRegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createProfileButton.setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                ...
                {
                    db.insertOrder("", name.getText().toString(), phone.getText().toString(), address.getText().toString(), city.getText().toString(), state.getText().toString(), zipcode.getText().toString());
    ...
    protected void writetoDB( String name, String phone, String address, String city, String state, String zipcode){
        ...
        String url ="composterRegisteration/"+ name;
